      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
           ...
           <!-- Cada bloco representa um serviço -->
          ...
          <div class="col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Fonoaudiologia</p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Engenharia da Computação</p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Publicidade e Propaganda</p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
